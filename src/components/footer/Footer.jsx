...
const Footer = () => {
	...
	return (
		<footer className="w-full bg-slate-900 text-slate-50 flex flex-col-reverse md:flex-row justify-between
		items-center px-12 py-4">
			<div className='flex flex-col-reverse md:flex-row items-center gap-4 mb-2 md:mb-0'>
			...
			<div className='w-56 cursor-pointer mt-2 mb-6 md:mb-0 md:mt-0' onClick={() => scrollTop()}>
